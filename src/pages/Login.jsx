...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
      e.preventDefault()
      setError('')
          await logIn(email, password).then(() => navigate('/')).catch((error) => {
            console.log(error);
  ...
  return (
    ...
    <div className='w-full h-screen'>
        <img className='hidden sm:block absolute w-full h-full object-cover' src="https://assets.nflxext.com/ffe/siteui/vlv3/ca6a7616-0acb-4bc5-be25-c4deef0419a7/c8686aa2-2b79-4fed-ba7e-1745e1517329/RO-ro-20231211-popsignuptwoweeks-perspective_alpha_website_large.jpg" alt="/" />
